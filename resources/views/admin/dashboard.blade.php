...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 border-l-4 border-l-indigo-500">
        ...
        <p class="text-3xl font-extrabold text-indigo-600 mt-2">{{ $totalJudulBuku }}</p>
    </div>
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 border-l-4 border-l-orange-500">
        ...
        <p class="text-3xl font-extrabold text-orange-500 mt-2">{{ $bukuDipinjam }}</p>
    </div>
</div>
<div class="bg-blue-50 p-6 rounded-xl border border-blue-100">
    <h3 class="font-bold text-blue-800 text-lg">Semangat Bertugas Admin!</h3>
